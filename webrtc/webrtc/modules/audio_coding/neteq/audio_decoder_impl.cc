...
bool CodecSupported(NetEqDecoder codec_type) {
  switch (codec_type) {
    ...
    case NetEqDecoder::kDecoderAAC_LC://-add by hsyuan.sdfsd
#endif
...
int CodecSampleRateHz(NetEqDecoder codec_type) {
  switch (codec_type) {
    ...
    //-add by hsyuan
    case NetEqDecoder::kDecoderAAC_LC: {
        return 48000;
    }
#endif
    case NetEqDecoder::kDecoderCNGswb48kHz: {
...
AudioDecoder* CreateAudioDecoder(NetEqDecoder codec_type) {
  ...
  switch (codec_type) {
    ...
    case NetEqDecoder::kDecoderAAC_LC: //-Add by hsyuan
      return new AudioDecoderAAC(2);
#endif
    case NetEqDecoder::kDecoderCNGnb:
    case NetEqDecoder::kDecoderCNGwb:
    case NetEqDecoder::kDecoderCNGswb32kHz:
