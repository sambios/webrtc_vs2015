...
#ifndef WEBRTC_MODULES_AUDIO_CODING_CODECS_AAC_AUDIO_DECODER_AAC_H_
#define WEBRTC_MODULES_AUDIO_CODING_CODECS_AAC_AUDIO_DECODER_AAC_H_
...
class AudioDecoderAAC final : public AudioDecoder {
 public:
  explicit AudioDecoderAAC(size_t num_channels);
 ...
 private:
  ...
  RTC_DISALLOW_COPY_AND_ASSIGN(AudioDecoderAAC);
};
